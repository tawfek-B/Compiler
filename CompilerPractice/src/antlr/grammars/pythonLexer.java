...
public class pythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DEF", "RETURN", "IF", "ELIF", "ELSE", "WHILE", "TRY", "FINALLY", "EXCEPT", 
			"FOR", "IN", "TRUE", "FALSE", "RANGE", "ROUTE", "ASSIGN", "PLUS", "MINUS", 
			"MULTIPLY", "DIVIDE", "MODIFY", "EQUAL", "NOT_EQUAL", "GREATER_EQUAL", 
			"LESS_EQUAL", "GREATER_THAN", "LESS_THAN", "LP", "RP", "LSB", "RSB", 
			"LCB", "RCB", "COLON", "COMMA", "SEMICOLON", "DOT", "NUMBER", "INT", 
