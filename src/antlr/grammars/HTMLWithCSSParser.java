...
public class HTMLWithCSSParser extends Parser {
	...
	public static final int
		...
		JINJA_ENDRAW=5, TAG_OPEN=6, SCRIPT_OPEN=7, STYLE_OPEN=8, XML=9, DTD=10, 
		CDATA=11, HTML_CONDITIONAL_COMMENT=12, HTML_COMMENT=13, SCRIPTLET=14, 
		SEA_WS=15, HTML_TEXT=16, TAG_CLOSE=17, TAG_SLASH_CLOSE=18, TAG_SLASH=19, 
		TAG_EQUALS=20, TAG_NAME=21, TAG_WHITESPACE=22, ATTVALUE_VALUE=23, ATTRIBUTE=24, 
		SCRIPT_BODY=25, SCRIPT_SHORT_BODY=26, STYLE_CLOSE=27, CHARSET=28, IMPORT=29, 
		KEYFRAMES=30, MEDIA=31, PAGE=32, VIEWPORT=33, FONTFACE=34, MARGIN_AREA=35, 
		ATKEYWORD=36, CLASSKEYWORD=37, STRING=38, UNCLOSED_STRING=39, HASH=40, 
		INDEX=41, NUMBER=42, PERCENTAGE=43, DIMENSION=44, URI=45, UNCLOSED_URI=46, 
		UNIRANGE=47, CDO=48, CDC=49, SEMICOLON=50, COLON=51, COMMA=52, LCURLY=53, 
		RCURLY=54, LPAREN=55, RPAREN=56, LBRACKET=57, RBRACKET=58, EXCLAMATION=59, 
		TILDE=60, MINUS=61, PLUS=62, ASTERISK=63, POUND=64, INCLUDES=65, DASHMATCH=66, 
		STARTSWITH=67, ENDSWITH=68, CONTAINS=69, EQUALS=70, SLASH=71, GREATER=72, 
		FUNCTION=73, IDENT=74, S=75, COMMENT=76, SL_COMMENT=77, IMPORTANT=78, 
		CSS_TEXT=79, JINJA_EXPR_CLOSE=80, JINJA_EXPR_CONTENT=81, JINJA_BLOCK_CLOSE=82, 
		JINJA_BLOCK_CONTENT=83, JINJA_COMMENT_CLOSE=84, JINJA_COMMENT_CONTENT=85, 
		JINJA_RAW_END=86, JINJA_RAW_CONTENT=87;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"JINJA_ENDRAW", "TAG_OPEN", "SCRIPT_OPEN", "STYLE_OPEN", "XML", "DTD", 
			"CDATA", "HTML_CONDITIONAL_COMMENT", "HTML_COMMENT", "SCRIPTLET", "SEA_WS", 
			...
			"MEDIA", "PAGE", "VIEWPORT", "FONTFACE", "MARGIN_AREA", "ATKEYWORD", 
			...
			"IMPORTANT", "CSS_TEXT", "JINJA_EXPR_CLOSE", "JINJA_EXPR_CONTENT", "JINJA_BLOCK_CLOSE", 
			"JINJA_BLOCK_CONTENT", "JINJA_COMMENT_CLOSE", "JINJA_COMMENT_CONTENT", 
	...
	public final HtmlDocumentContext htmlDocument() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 63454L) != 0)) {
				{
				{
				setState(68);
				documentItem();
	...
	public final StylesheetContext stylesheet() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 28)) & ~0x3f) == 0 && ((1L << (_la - 28)) & 211141174236031L) != 0)) {
				{
				setState(167);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final AtstatementContext atstatement() throws RecognitionException {
		...
		try {
			...
			case MEDIA:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((((_la - 28)) & ~0x3f) == 0 && ((1L << (_la - 28)) & 70403682734975L) != 0)) {
					{
					{
					setState(272);
					media_rule();
