...
public class HTMLWithCSSParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class JinjaCommfsentItemContext extends DocumentItemContext {
		public JinjaCommentContext jinjaComment() {
			return getRuleContext(JinjaCommentContext.class,0);
		}
		public JinjaCommfsentItemContext(DocumentItemContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HTMLWithCSSParserListener ) ((HTMLWithCSSParserListener)listener).enterJinjaCommfsentItem(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HTMLWithCSSParserListener ) ((HTMLWithCSSParserListener)listener).exitJinjaCommfsentItem(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HTMLWithCSSParserVisitor ) return ((HTMLWithCSSParserVisitor<? extends T>)visitor).visitJinjaCommfsentItem(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final DocumentItemContext documentItem() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				break;
			case 9:
				_localctx = new JinjaCommfsentItemContext(_localctx);
